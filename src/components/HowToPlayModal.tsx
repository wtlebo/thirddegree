...
export const HowToPlayModal: React.FC<HowToPlayModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content how-to-play-modal" onClick={e => e.stopPropagation()} style={{ position: 'relative', paddingTop: '30px', paddingBottom: '20px' }}>
                <button className="close-btn" onClick={onClose} style={{ position: 'absolute', right: '15px', top: '10px' }}>&times;</button>

                <div className="stats-header" style={{ justifyContent: 'center', marginBottom: '0.5rem' }}>
                    <h2>How to Play</h2>
                </div>

                <div style={{ textAlign: 'left', color: 'var(--color-text)', lineHeight: '1.4', fontSize: '0.9rem' }}>
                    <p style={{ marginBottom: '0.8rem' }}>
                        <strong>Hang 10</strong> is a daily word puzzle game. Your goal is to solve 5 puzzles with as few strikes as possible.
                    </p>

                    <h3 style={{ color: 'var(--color-secondary)', marginTop: '1rem', marginBottom: '0.3rem' }}>Rules</h3>
                    <ul style={{ paddingLeft: '20px', marginBottom: '0.8rem' }}>
                    ...
                    <h3 style={{ color: 'var(--color-secondary)', marginTop: '1rem', marginBottom: '0.3rem' }}>Riding the Wave</h3>
                    <p style={{ marginBottom: '0.3rem' }}>
                        Do well to get a momentum bonus on the next puzzle!
                    </p>
                    <ul style={{ paddingLeft: '20px', marginBottom: '0.8rem' }}>
                    ...
                    <h3 style={{ color: 'var(--color-secondary)', marginTop: '1rem', marginBottom: '0.5rem' }}>Scoring</h3>
                    <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto', gap: '5px 15px', alignItems: 'center', fontSize: '0.85rem' }}>
                        {/* Rows */}
                        <span>0 Strikes</span>
                        ...
                        <span>5 Strikes</span>
                        <span style={{ color: 'var(--color-primary)' }}>WIPE OUT</span>
                        <span>0 pts</span>
                    </div>

                    <p style={{ marginTop: '1rem', fontStyle: 'italic', textAlign: 'center', opacity: 0.8 }}>
