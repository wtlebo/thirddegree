...
export const Header: React.FC<HeaderProps> = ({ strikes }) => {
    return (
        <header className="game-header">
            <div className="logo-container">
                <svg className="game-logo-svg" viewBox="0 0 400 80" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <line x1="10" y1="40" x2="40" y2="40" stroke="#2ec4b6" strokeWidth="2" />
                    <line x1="360" y1="40" x2="390" y2="40" stroke="#a78bfa" strokeWidth="2" />

                    {/* Circuit Traces */}
                    <circle cx="40" cy="40" r="3" fill="#2ec4b6" />
                    <circle cx="360" cy="40" r="3" fill="#a78bfa" />
                    <path d="M40,40 L60,40 L70,25" fill="none" stroke="#2ec4b6" strokeWidth="1" opacity="0.5" />
